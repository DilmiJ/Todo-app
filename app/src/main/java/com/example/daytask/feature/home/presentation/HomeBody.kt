...
import com.example.daytask.feature.home.HomeUiState
...
import com.example.daytask.core.ui.theme.SeeAllText
import com.example.daytask.core.ui.theme.SmallPercentageText
...
fun CompleteLine(
    ...
    Column(modifier = modifier) {
        Row(
            ...
            horizontalArrangement = Arrangement.SpaceBetween,
            modifier = Modifier
                .padding(bottom = dimensionResource(R.dimen.offset_2))
                .fillMaxWidth()
        ) {
            Text(
