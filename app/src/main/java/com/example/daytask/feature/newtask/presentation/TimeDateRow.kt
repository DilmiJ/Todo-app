...
import com.example.daytask.core.common.util.Constants.timeLimit
...
import com.example.daytask.core.ui.theme.DateText
...
fun TimeDateRow(
    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(dimensionResource(R.dimen.offset_8))) {
            DateCard(
...
private fun timeCheck(
    ...
    when {
        selectedMin < currentMin -> {
            ...
            dateState.selectedDateMillis = currentTime
        }
